...
Скачайте `hh-mcp-ru-vX.Y.Z.mcpb` со [страницы релизов](https://github.com/ilyautov/hh-mcp-ru/releases/latest)
...
Полный текст: [PRIVACY_POLICY.md](https://github.com/ilyautov/hh-mcp-ru/blob/main/PRIVACY_POLICY.md).
